    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            if UIDevice.current.userInterfaceIdiom == .phone {
                IPhoneAnimationView(vehicle: vehicle, avm: avm, tcvm: tcvm, width: w, height: h, isLandscape: isLandscape)
                ...
                IPadAnimationView(vehicle: vehicle, avm: avm, tcvm: tcvm, width: w, height: h, isLandscape: isLandscape)
...
// MARK: - iPhone Layout
struct IPhoneAnimationView: View {
    let vehicle: Vehicle
        ...
        VStack(spacing: height * 0.03) {
            ...
            HStack {
                Button {
                    ...
                    tcvm.isStart ? tcvm.stop() : tcvm.stopWatchStart()
                    
                } label: {
                    Text(avm.isRunning ? "S T O P" : "S T A R T")
